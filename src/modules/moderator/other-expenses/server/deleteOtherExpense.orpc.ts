...
import { z } from "zod";
import { db } from "@/db";
import { OtherExpense, BottleUsage } from "@/db/schema";
import { eq, and, gte, lte } from "drizzle-orm";
import { endOfDay, startOfDay } from "date-fns";
import { ORPCError } from "@orpc/client";

export const deleteOtherExpense = os
    .input(
        z.object({
            expenseId: z.string(),
        ...
        try {
            ...
            await db
                ...
                .set({
                    ...
                    remaining_bottles: usage.remaining_bottles - input.reffilledBottles,
            ...
            await db.delete(OtherExpense).where(eq(OtherExpense.id, input.expenseId));
